...
try:
    ...
    print("That is not a number, but if you want to be sneaky that is cool too.")
...
print(num0 + num2)
print("Yes!, the correct answer is C, 4!")
...
# Testing the built-in "pow" function.
print(int(pow(2, 3)))
print("Yes!, the correct is A, 8!")
...
print(int(num2/num1))
print("Yes! The correct answer is A, 4!")
...
print(num2 % num1)
print("Yes! The correct answer is B, 1!")
...
print("Yes!, the correct answer is A, 2!")
...
# Tenth math problem deals with a for statement and seeing if a variable is greater than y or 5.
x, y, z = 4, 5, 6
print("\nQuestion 10:",
      "X = 4, Y = 5, Z = 6",
...
greet()
print("\nThis is where we will continue later on")
